...
async def chat(body: ChatQuery):
    ...
    if "ciclo" in q:
        target = "retiro_ciclo"
    elif "asignatura" in q:
        target = "retiro_asignatura"
    elif "reserva" in q:
        target = "reserva"
    elif "reactualizacion" in q:
        target = "reactualizacion"
    elif "condicionada" in q:
        target = "matricula_condicionada"
    elif "foto" in q:
        target = "registro_foto"
    elif "encuesta" in q:
        target = "encuesta"
    elif "inasistencia" in q or "justificacion" in q:
        target = "justificacion"
